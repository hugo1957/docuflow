...
class PhoneInputDropdown(ft.Row):
    ...
    def _create_dropdown(self):
        """Crea el Dropdown con banderas y códigos de país."""
        # Generamos las opciones usando la info de self.country_data
        options = [
            ft.dropdown.Option(
                key=key,
                content=ft.Row(
    ...
    def _create_phone_field(self):
        """Crea el TextField para el número de teléfono."""
    ...
    def handle_country_change(self, e):
        """Callback para manejar el cambio de país en el Dropdown."""
    ...
    def handle_phone_change(self, e):
        """Callback para manejar el cambio de texto en el campo telefónico."""
